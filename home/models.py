...
class ProfileImages(models.Model):
    user = models.ForeignKey('PersonalInfo', on_delete=models.CASCADE, related_name="user",
                             default=None)  # Add related_name
...
class Category(models.Model):
    project = models.ForeignKey('projectinfo', on_delete=models.CASCADE, related_name="proj_category",
                                default=None)  # Add related_name
...
class Technology(models.Model):
    project = models.ForeignKey('projectinfo', on_delete=models.CASCADE, related_name="proj_technology",
                                default=None)  # Add related_name
...
class Feature(models.Model):
    project = models.ForeignKey('projectinfo', on_delete=models.CASCADE, related_name="project_feature", null=True,
                                blank=True)
...
class Workkeyresponsiblities(models.Model):
    key_responsiblity = models.ForeignKey(WorkexperienceInfo, related_name="key_responsiblity",
